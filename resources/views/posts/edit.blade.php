...
@extends('layouts.vertical', ['title' => '공지사항 수정'])
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div>
                                ...
                                <textarea name="description" class="form-control" placeholder="내용" rows="10">{{ $post->description }}</textarea><br>    
                            </div>
                            ...
                            <div class="row">
                                    <div class="col-lg-6">
                                        <!-- 등록 날짜 -->
                                        <label>시작날짜</label>
                                        <input name="starttime" type="date" class="form-control" value="{{$post->starttime}}">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>종료날짜</label>
                                        <input name="endtime" type="date" class="form-control" value="{{$post->endtime}}">
                                    </div>
                            </div><br>
